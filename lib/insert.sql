-- INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, 'harry potter', 2, 3), (2, 'lord of the rings', 4, 5);

-- INSERT INTO books (id, title, year, series_id) VALUES (1, 'blah', 1999, 2), (2, 'blah', 1999, 4), (3, 'blah', 1999, 8), (4, 'blah', 1999, 12),(5, 'blah', 1999, 16), (6, 'blah', 1999, 20);
